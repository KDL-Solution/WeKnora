export default {
  ...
  settings: {
    ...
    weknoraCloud: {
      title: "Cloud Parser",
      description: "配置 Cloud Parser 的 APPID 和 APPSECRET 凭证。凭证用于模型服务和文档解析引擎。",
      viewDocs: "查看文档",
      unconfigured: "尚未配置凭证，请填写 APPID 和 APPSECRET",
      configured: "凭证已配置，状态正常",
      expired: "Cloud Parser 凭证已失效",
      expiredDefault: "服务重启后加密密钥已变更，已保存的凭证无法解密。请重新填写凭证。",
      reconfigure: "重新配置",
      appIdLabel: "APPID",
      appIdDesc: "Cloud Parser 的应用 ID",
      appIdPlaceholder: "请输入 APPID",
      appSecretLabel: "APPSECRET",
      appSecretDesc: "Cloud Parser 的应用密钥",
      appSecretPlaceholder: "请输入 APPSECRET",
      saveHint: "保存后将验证服务可达性并加密存储凭证",
      saveBtn: "保存凭证",
      usageTitle: "使用说明",
      usageSteps: "1. 在此页面填写并保存 APPID 和 APPSECRET\n2. 模型服务：前往「模型管理」添加模型，选择 Remote API 来源，厂商选择「Cloud Parser」\n3. 文档解析：前往「知识库设置 → 解析引擎」，为对应文件类型选择「Cloud Parser」引擎",
      fillRequired: "请填写 APPID 和 APPSECRET",
      saveSuccess: "凭证保存成功",
      saveFailed: "凭证保存失败",
      credentialConfigured: "Cloud Parser 凭证已配置",
      credentialExpired: "凭证已失效，请重新配置。",
      credentialUnconfigured: "尚未配置 Cloud Parser 凭证，请先填写 APPID 和 APPSECRET。",
      checkingStatus: "正在检查凭证状态...",
      goToSettings: "前往设置中配置",
      modelHintConfigured: "Cloud Parser 凭证已配置。支持的模型可参考",
    ...
    storage: {
      ...
      configurable: "可配置",
      pathPrefix: "路径前缀（可选）",
      pathPrefixPlaceholder: "如 deep-office/images",
      prefixPlaceholder: "如 deep-office",
  ...
  system: {
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（deep-office-app）的版本号",
    frontendVersionLabel: "UI 版本",
    frontendVersionDescription: "当前 UI 界面（deep-office-ui）的构建版本号",
  ...
  platform: {
    subtitle: "Korea Deep Learning 内部知识搜索系统",
    description: "快速查找答案，并保留文档来源与证据上下文",
    rag: "RAG 增强生成",
    hybridSearch: "混合检索",
    localDeploy: "本地部署",
  ...
  createChat: {
    title: "Hi，我是 Deep Office，让你的知识触手可及",
    newSessionTitle: "新会话",
    messages: {
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: "Cloud Parser",
          desc: "使用 Cloud Parser 进行文档解析",
        },
        deep_parser: {
          name: "DeepParser",
          desc: "先通过 Converter 转为页面图片，再用 DeepParser ultra_mineru 结构化",
        },
      },
    },
    supportedFormats: "支持格式",
