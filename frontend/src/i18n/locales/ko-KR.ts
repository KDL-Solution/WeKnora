export default {
  ...
  settings: {
    ...
    storage: {
      ...
      pathPrefixPlaceholder: '예: deep-office/images',
      prefixPlaceholder: '예: deep-office',
  ...
  initialization: {
    title: "초기화",
    welcome: "Deep Office에 오신 것을 환영합니다",
  ...
  auth: {
    login: "로그인",
    loginWelcome: "Deep Office에 오신 걸 환영합니다",
    logout: "로그아웃",
    username: "사용자명",
    email: "이메일",
    password: "비밀번호",
    ...
    subtitle: "사내 지식 검색과 문서 기반 질의응답을 시작하세요",
  ...
  system: {
    ...
    retry: "재시도",
    versionLabel: "앱 버전",
    versionDescription: "애플리케이션 서비스(deep-office-app)의 버전 번호",
    frontendVersionLabel: "UI 버전",
    frontendVersionDescription: "UI(deep-office-ui) 빌드 버전 번호",
  ...
  platform: {
    subtitle: "Korea Deep Learning의 사내 지식 검색 시스템",
    description: "업무 문서의 출처와 근거를 따라가며 빠르게 답을 찾습니다",
    rag: "RAG 강화 생성",
  ...
  createChat: {
    title: "안녕하세요, Deep Office입니다 — 당신의 지식을 손끝에",
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Cloud Parser',
          desc: 'Cloud Parser를 통한 문서 파싱',
        },
        deep_parser: {
          name: 'DeepParser',
          desc: 'Converter로 문서를 이미지화한 뒤 DeepParser ultra_mineru로 구조화합니다',
        },
      },
    },
    supportedFormats: '지원 형식',
