export default {
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'Cloud Parser',
      description: 'Configure Cloud Parser APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'Cloud Parser credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'Cloud Parser application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Cloud Parser application secret',
      ...
      usageSteps: '1. Fill in and save APPID and APPSECRET on this page\n2. Model services: Go to Model Management, add a model with Remote API source, select Cloud Parser as provider\n3. Document parsing: Go to Knowledge Base Settings → Parser Engine, select Cloud Parser engine for desired file types',
      ...
      credentialConfigured: 'Cloud Parser credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'Cloud Parser credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'Cloud Parser credentials configured. See supported models in',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. deep-office/images',
      prefixPlaceholder: 'e.g. deep-office',
  ...
  initialization: {
    ...
    welcome: 'Welcome to Deep Office',
  ...
  auth: {
    login: 'Login',
    loginWelcome: 'Welcome to Deep Office',
    logout: 'Logout',
    ...
    subtitle: 'Start internal knowledge search and document-grounded Q&A',
  ...
  createChat: {
    title: 'Hi, I am Deep Office — your knowledge, within reach',
...
\
  ...
  system: {
    ...
    versionDescription: 'Version of the application service (deep-office-app)',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI (deep-office-ui)',
  ...
  platform: {
    subtitle: 'Internal knowledge search by Korea Deep Learning',
    description: 'Find answers quickly while keeping document evidence and source context visible',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      fileTypeOtherDocument: 'Korean Documents',
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Cloud Parser',
          desc: 'Document parsing via Cloud Parser',
        },
        deep_parser: {
          name: 'DeepParser',
          desc: 'Converts documents to page images, then structures them with DeepParser ultra_mineru',
        },
      },
    },
    supportedFormats: 'Supported formats',
