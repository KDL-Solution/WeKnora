export default {
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'Cloud Parser',
      description: 'Настройте учётные данные APPID и APPSECRET для Cloud Parser. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные Cloud Parser истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения Cloud Parser',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения Cloud Parser',
      ...
      usageSteps: '1. Заполните и сохраните APPID и APPSECRET\n2. Модели: перейдите в управление моделями, добавьте модель с источником Remote API, выберите Cloud Parser\n3. Парсинг документов: перейдите в настройки базы знаний → движок парсинга, выберите Cloud Parser для нужных типов файлов',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные Cloud Parser настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные Cloud Parser не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные Cloud Parser настроены. Поддерживаемые модели см. в',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'напр. deep-office/images',
      prefixPlaceholder: 'напр. deep-office',
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в Deep Office',
  ...
  auth: {
    login: 'Вход',
    loginWelcome: 'Добро пожаловать в Deep Office',
    logout: 'Выход',
    ...
    subtitle: 'Начните внутренний поиск знаний и ответы по документам',
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения (deep-office-app)',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки UI (deep-office-ui)',
  ...
  createChat: {
    title: 'Привет, я Deep Office — ваши знания всегда под рукой',
  ...
  platform: {
    subtitle: 'Внутренний поиск знаний Korea Deep Learning',
    description: 'Быстро находите ответы с видимыми источниками и контекстом документов',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Cloud Parser',
          desc: 'Парсинг документов через Cloud Parser',
        },
      },
    },
    supportedFormats: 'Поддерживаемые форматы'
