...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 Deep Office？',
    answers: ['Deep Office 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['Deep Office 是什么？', '介绍一下 Deep Office'],
    negative_questions: ['这不是 Deep Office', '与 Deep Office 无关'],
    tag_name: '产品介绍',
  },
  {
